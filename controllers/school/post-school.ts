...
const postSchool = async (req, res, authenticate_user) => {
  try {
    ...
    const { name, phone, email, address, admin_ids, currency, domain, main_balance, masking_sms_price, non_masking_sms_price, masking_sms_count, non_masking_sms_count } = req.body;
