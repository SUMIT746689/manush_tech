...
import PageHeader from 'src/content/Management/AddtionalResult/PageHeader';
import Footer from 'src/components/Footer';
import PageTitleWrapper from 'src/components/PageTitleWrapper';
import { Card, Grid } from '@mui/material';
import Results from 'src/content/Management/AddtionalResult/Results';
...
function Managementschools() {
  ...
  const [examAddtionalMarkingList, setExamAddtionalMarkingList] = useState(null);
    ...
    <>
      ...
      <PageTitleWrapper>
        <PageHeader
          ...
          exams={exams}
          examAddtionalMarkingList={examAddtionalMarkingList}
          setExamAddtionalMarkingList={setExamAddtionalMarkingList}
