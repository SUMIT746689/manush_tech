        ...
        >
          <Grid px={1} pt="9px">
            ...
            >
              ...
              >
                <AutoCompleteWrapper options={[]} value={''} label="Select User" placeholder="Select a User" handleChange={() => {}} />
              </Grid>
          ...
          <Table sx={{ minWidth: 650, maxWidth: 'calc(100%-10px)' }} size="small" aria-label="a dense table">
            <TableHead>
              <TableRow>
                ...
                <TableHeaderCellWrapper style={{ width: '9%' }}>Date</TableHeaderCellWrapper>
                <TableHeaderCellWrapper style={{ width: '9%' }}>Boucher No</TableHeaderCellWrapper>
                <TableHeaderCellWrapper style={{ width: '30%' }}>Heads</TableHeaderCellWrapper>
                <TableHeaderCellWrapper style={{ width: '20%' }}>Note</TableHeaderCellWrapper>
                <TableHeaderCellWrapper style={{ width: '30%' }}>Amount</TableHeaderCellWrapper>
              </TableRow>
            </TableHead>
            <TableBody>
              <StyledTableRow>
              ...
              <TableRow>
                <TableBodyCellWrapper colspan={5}>
