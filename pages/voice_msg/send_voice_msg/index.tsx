                    ...
                    value: (
                      <SendSmsWrapper>
                        <VoiceRecipient
                          ...
                          templates={
                            gateways && Array.isArray(gateways) ? templates : []
                          }
                        />
                        <Grid
                          maxWidth={350}
  ...
  return (
    <Card
      sx={{
        ...
        color: colorBlue,
        p: 3,
        minWidth: { xs: 'fit-content', md: 350 },
        mt: 1,
        mb: 'auto',
        borderRadius: 0.5
      }}
    >
      <Grid sx={{ fontSize: 18, fontWeight: 700, textAlign: 'center' }}>
        Available Balance
      </Grid>
      <Divider />
      <Grid
...
const VoicePrice = () => {
  const { user } = useAuth();
  const { school } = user || {};
  const { voice_pulse_size, voice_sms_balance, voice_sms_price }: any =
    school || {};
