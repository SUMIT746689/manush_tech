...
-- AlterTable
ALTER TABLE `website_uis` MODIFY `history_description` TEXT NULL,
    MODIFY `chairman_speech` TEXT NULL,
    MODIFY `principal_speech` TEXT NULL,
    MODIFY `school_history` TEXT NULL;
