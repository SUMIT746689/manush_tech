/*
  ...
  - You are about to drop the `tbl_student_attendace_queue` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropForeignKey
ALTER TABLE `tbl_student_attendace_queue` DROP FOREIGN KEY `tbl_student_attendace_queue_academic_year_id_fkey`;

-- DropForeignKey
ALTER TABLE `tbl_student_attendace_queue` DROP FOREIGN KEY `tbl_student_attendace_queue_class_id_fkey`;

-- DropForeignKey
ALTER TABLE `tbl_student_attendace_queue` DROP FOREIGN KEY `tbl_student_attendace_queue_school_id_fkey`;

-- DropForeignKey
ALTER TABLE `tbl_student_attendace_queue` DROP FOREIGN KEY `tbl_student_attendace_queue_section_id_fkey`;

-- DropTable
DROP TABLE `tbl_student_attendace_queue`;
