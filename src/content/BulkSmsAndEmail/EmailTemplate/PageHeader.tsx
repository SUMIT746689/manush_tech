...
function PageHeader({ editData, setEditData, reFetchData }) {
  ...
  const handleFormSubmit = async (
    ...
    try {
      ...
      if (editData) {
        const res = await axios.patch(`/api/email_templates/${editData.id}`, _values);
        successResponse('updated');
      } else {
        const res = await axios.post(`/api/email_templates`, _values);
  ...
  return (
    <>
      ...
      <PageHeaderTitleWrapper name="email template" handleCreateClassOpen={handleCreateClassOpen} />
      ...
      >
        {/* dialog title */}
        <DialogTitleWrapper name={"Email Templates"} editData={editData} />
