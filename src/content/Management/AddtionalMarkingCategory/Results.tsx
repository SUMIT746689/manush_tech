...
const Results = ({ setEditSubject, users }) => {
      ...
      <Card sx={{ minHeight: '64.8vh' }}>
        <Box p={2}>
          <TextField
            ...
            placeholder={t('Search by addtional marking categorie name...')}
            value={query}
            size="small"
            fullWidth
            margin="normal"
        ...
        {paginatedSubjects.length === 0 ? (
          <>
            <Typography
              ...
              align="center"
            >
              {t("We couldn't find any addtional marking categories matching your search criteria")}
            </Typography>
          </>
        ) : (
          <>
