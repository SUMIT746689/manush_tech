      ...
      <TableRow>
        <TableCell style={{ paddingBottom: 0, paddingTop: 0 }} colSpan={6}>
          <Collapse in={rowSectionOpen} timeout="auto" unmountOnExit>
            ...
            {/* addtional marks */}
            <Box sx={{ margin: 1 }}>
              <Typography variant="h6" gutterBottom component="div" color="sienna">
                Addtional marks:
              </Typography>
              <Table size="small" aria-label="purchases">
                <TableHead>
                  <TableRow>
                    ...
                    <TableCell>Obtain marks</TableCell>
                ...
                <TableBody>
                  ...
                  {
                    row?.StudentAddtionalResultDetails?.map(markRow =>
                      <TableRow key={markRow.id}>
                        <TableCell>
                          <Typography noWrap variant="h5">
                            {markRow?.exaxmAddtionalMark?.addtionalMarkingCategorie?.title}
                          </Typography>
                        </TableCell>
                        <TableCell>
                          <Typography noWrap variant="h5">
                        ...
                        <TableCell ><Typography noWrap variant="h5">
                          {customizeDate(markRow?.created_at)}
                        </Typography></TableCell>
                      </TableRow>
