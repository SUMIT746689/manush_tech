...
const Results: FC<ResultsProps> = ({
  ...
  const handleDeleteCompleted = async () => {
    try {
      ...
      setOpenConfirmDelete(false);
      showNotification('The package falied to delete ','error');
    }
  };
          ...
          <Grid item xs={12}>
            <Box p={0.5}>
              <TextField
                ...
                placeholder={t('Search by packages title or price...')}
                value={query}
                fullWidth
                variant="outlined"
              />
                  ...
                  {paginatedPackages.map((singlePackage) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell>
                          <Typography noWrap variant="h5">
                            {singlePackage.duration} - Days
                          </Typography>
                        </TableCell>
                        <TableCell>
                          <Typography noWrap variant="h5">
                            {singlePackage.student_count}
                          </Typography>
                        </TableCell>
                        <TableCell align="center">
                          <Typography noWrap>
                            <Tooltip title={t('Edit')} arrow>
                              <IconButton
                                onClick={() => setEditData(singlePackage)}
                                color="primary"
                              >
                            ...
                            <Tooltip title={t('Delete')} arrow>
                              <IconButton
                                onClick={() =>
                                  handleConfirmDelete(singlePackage.id)
                                }
                                color="primary"
                              >
