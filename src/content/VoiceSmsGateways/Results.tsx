          ...
          <Grid item xs={12}>
            <Box p={1}>
              <TextField
                ...
                placeholder={t('Search by voice sms gateways...')}
                value={query}
                fullWidth
                variant="outlined"
              />
      ...
      <Card sx={{ minHeight: 'calc(100vh - 428px) !important' }}>
        ...
        >
          <Box>
            ...
            <b>{paginatedschools.length}</b> <b>{t('voice sms gateways')}</b>
          </Box>
          <TablePagination
            component="div"
        ...
        {paginatedschools.length === 0 ? (
          <>
            ...
            >
              {t(
                "We couldn't find any voice sms gateways matching your search criteria"
              )}
            </Typography>
          </>
        ) : (
          <>
            <TableContainer>
              <Table size="small">
                <TableHead>
                  <TableRow>
                    <TableCell align="left">{t('School Name')}</TableCell>
                    <TableCell align="left">{t('Sender Id')}</TableCell>
