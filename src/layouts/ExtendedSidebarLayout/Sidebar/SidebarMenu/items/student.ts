...
const view_attendence: MenuItems[] = [
    {
        items: [
            {
                name: 'Student Exam Attendence',
...
const payment_report: MenuItems[] = [
    {
        items: [
            {
                name: 'Fees',
...
const tabulation_sheet: MenuItems[] = [
    {
        items: [
        ]
    }
