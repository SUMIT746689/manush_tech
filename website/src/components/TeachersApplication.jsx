...
import {
    Button, styled, Grid, Typography, useTheme, Box, TextField,
    Autocomplete, FormControl, InputLabel, Select, MenuItem, FormHelperText, DialogActions, CircularProgress
} from '@mui/material';
...
const TeachersApplication = ({ departments, serverHost }) => {
    ...
    const handleFormSubmit = async (
        ...
        try {
            ...
            const res = await axios.post(`${serverHost}/api/teacher_recruitment`, formData);
                            ...
                            <Grid container columnSpacing={1}>
                                ...
                                <Grid item xs={12}>
                                    ...
                                    >
                                        ...
                                        {
                                            errors?.resume && <Typography sx={{ color: 'red' }}>{errors?.resume}</Typography>
                                        }
                                    </Grid>
                                </Grid>
