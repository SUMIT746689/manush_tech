    ...
    return (
        <Grid display="grid" gap={8}>
            <Grid display="grid" gridTemplateColumns="1fr 1fr 1fr" justifyContent="space-between"  >
                <Grid>
                    <Image
                        src={`${serverHost}/api/get_file/${school?.websiteui[0].header_image}`}
                        width={200}
                        height={200}
                        alt={"school_image"}
                        loading='lazy'
                ...
                <Grid fontFamily="cursive" textAlign="center" >
                    <Typography variant="h4" color="goldenrod" fontFamily="cursive" >{school?.name}</Typography>
                    <Grid>{school?.address}</Grid>
                </Grid>
                <Grid display="flex" justifyContent="end" >
                    {values?.student_photo
                        &&
                        <Card sx={{ borderRadius: 100, overflow: "hidden", border: "5px solid white", height: 200, width: 200, boxShadow: 3 }}>
            ...
            <Grid sx={{ display: "flex", justifyContent: "space-between", px: 10 }}>
